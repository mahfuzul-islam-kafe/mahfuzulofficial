<x-admin>
    ...
    <form action="{{route('admin.services.store')}}"  autocomplete="off" class="needs-validation" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input id="projectname-input" name="icon" type="text" class="form-control"
                                placeholder="Put the icon here..." required>
                        </div>
