<x-admin>
    ...
    <form action="{{ route('admin.portfolios.update', $item) }}" autocomplete="off" class="needs-validation" method="POST"
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input id="projectname-input" name="title" type="text" class="form-control"
                                placeholder="Enter project name..." required value="{{ $item->title }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="projectdesc-input" name="description" rows="3"
                                placeholder="Enter project description..." required>{{ $item->description }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <img src="{{ Storage::url($item->image) ?? asset('assets/img/no-image.png') }}"
                                    alt="" id="image-preview" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <!-- end card body -->
            ...
            <div class="col-lg-4">
                            ...
                            <select class="form-select" id="project-status-input" name="type">
                                @foreach ($types as $type)
                                    <option value="{{ $type->type }}"
                                        {{ $type->type == $item->type ? 'selected' : '' }}>{{ $type->display_type }}
                                    </option>
                                @endforeach
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="text" name="delivery" value="{{ $item->delivery }}" class="form-control" />
                    </div>
                    <!-- end card body -->
                </div>
                <!-- end card -->
